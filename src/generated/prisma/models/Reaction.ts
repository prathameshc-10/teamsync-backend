...
export type ReactionWhereInput = {
  ...
  reacctionId?: Prisma.IntFilter<"Reaction"> | number
...
export type ReactionScalarWhereWithAggregatesInput = {
  ...
  reacctionId?: Prisma.IntWithAggregatesFilter<"Reaction"> | number
...
export type ReactionUncheckedUpdateInput = {
  reacctionId?: Prisma.IntFieldUpdateOperationsInput | number
...
export type ReactionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"reacctionId" | "messageId" | "userId" | "emoji" | "createdAt", ExtArgs["result"]["reaction"]>
...
export interface ReactionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `reacctionId`
   * const reactionWithReacctionIdOnly = await prisma.reaction.findMany({ select: { reacctionId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Reactions and only return the `reacctionId`
   * const reactionWithReacctionIdOnly = await prisma.reaction.createManyAndReturn({
   *   select: { reacctionId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more Reactions and only return the `reacctionId`
   * const reactionWithReacctionIdOnly = await prisma.reaction.updateManyAndReturn({
   *   select: { reacctionId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ReactionFieldRefs {
  readonly reacctionId: Prisma.FieldRef<"Reaction", 'Int'>
